#!/bin/bash
#
# tests/skills/test_verona_treasury.sh - Treasury Skill Tests
#
# Tests for verona-treasury skill including list, query, create, fund, and withdraw.
#
# Usage:
#   MOCK_ENABLED=true ./test_verona_treasury.sh
#
# Environment:
