#!/bin/bash
#
# tests/skills/test_verona_asset.sh - Asset Skill Tests
#
# Tests for verona-asset skill including types, create, mint, and query operations.
#
# Usage:
#   MOCK_ENABLED=true ./test_verona_asset.sh
#
# Environment:
