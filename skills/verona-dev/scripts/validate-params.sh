...
#
# Example:
#   validate-params.sh verona-treasury grant-config-add '{"address": "xion1abc...", "auth-type": "send"}'
#
# Output:
#   {
#     "valid": false,
...
Arguments:
  skill       - Skill name (e.g., verona-treasury, verona-asset, verona-oauth2)
...
Examples:
  ...
  # Validate asset mint
  validate-params.sh verona-asset mint '{"contract": "xion1abc...", "token-id": "1", "owner": "xion1..."}'

  # Validate oauth2 login
  validate-params.sh verona-oauth2 login '{}'
